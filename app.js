...
discos.push(new Disco("Random Access Memories", "Druft Punk", 42000))
discos.push(new Disco("play", "Moby", 38000))
discos.push(new Disco("Untrue", "Burial", 26000))
discos.push(new Disco("Dummy", "Portishead", 120000))
discos.push(new Disco("Computerwelt", "Kraftwerk", 545000))

//funciones

function datosPersonales() {
    cliente = prompt("Bienvenido a nuestra tienda de discos de musica electronica Musante Records ¿Cómo es su nombre?");
